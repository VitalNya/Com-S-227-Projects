...
/**
 * Utility methods for creating various examples of Maxi Yatzy games.
 * 
 * @author smkautz
 */
public class ExampleGameFactory {
	/**
	 * Creates and returns a very small version of Yahtzee. There is just one score
	 * box, which is to roll as many sixes as possible
	 * 
	 * @return tiny game
	 */
	public static MaxiYatzy createReallyTinyGame(Random rand) {
		GameConfiguration config = new GameConfiguration(5, // five dice
				6, // max value 6
				3, // 3 rolls per turn
	...
	/**
	 * Creates and returns a short version of Maxi Yatzy. There are four dice with
	 * values 1 through 4. There are no upper section categories.
	 * 
	 * @return small game
	 */
...
// UNCOMMENT AS YOU GET THESE IMPLEMENTED
		...
		GameConfiguration config = new GameConfiguration(4, // four dice
				4, // max value 4
				3, // 3 rolls per turn
				0, // upper section bonus
				0, // upper section bonus cutoff
	...
	/**
	 * Creates and returns a default based based on more or less standard score
	 * boxes for Yahtzee.
	 * 
	 * @return game based on standard rules
	 */
	public static MaxiYatzy createDefault(Random rand) {
		String[] upperSectionNames = { "Aces", "Twos", "Threes", "Fours", "Fives", "Sixes", };
...
// UNCOMMENT WHEN YOU HAVE IMPLEMENTED MatchTargetScoreBox
	...
	/**
	 * Creates and returns a default based based on more or less standard score
	 * boxes for Maxi Yatzy
	 * 
	 * @return game based on standard rules
	 */
	public static MaxiYatzy createMaxi(Random rand) {
		String[] upperSectionNames = { "Ones", "Twos", "Threes", "Fours", "Fives", "Sixes", };
...
// UNCOMMENT AS YOU GET THESE IMPLEMENTED 
		...
		GameConfiguration config = new GameConfiguration(6, // six dice
				6, // max value 6
				3, // 3 rolls per turn
				35, // upper section bonus
				63, // upper section bonus cutoff
