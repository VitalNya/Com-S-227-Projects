...
public class TwoDMaze {
	...
	/**
	 * Constructs a maze based on a 2D grid. The given strings represent rows of the
	 * maze, where '#' represents a wall, a blank represents a possible path, 'S'
	 * represents the starting cell, and '$' represents the goal.
	 * 
	...
	/**
	 * Set an observer for all cells in this maze. When a cell's status changes, the
	 * observer's statusChanged method is called.
	 * 
	 * @param givenObserver an instance of MazeObserver
	 */
