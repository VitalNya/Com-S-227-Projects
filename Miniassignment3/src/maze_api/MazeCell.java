...
public class MazeCell {
	...
	/**
	 * Constructs a maze cell at the given location with default status NOT_STARTED
	 * and no observer.
	 */
	public MazeCell() {
	 ...
	 * 
	 * @param s new status for the cell
	 */
	...
	/**
	 * Set an observer for this cell. When the cell's status changes, the observer's
	 * statusChanged method is called.
	 * 
	 * @param givenObserver an instance of GridObserver
	 */
