package twenty_four_api;

/**
 * Encapsulates an integer value and a text representation of how the value was
 * obtained.
 */
public class IntExpression {
	 ...
	 * objects using the given operator. Allowed operators are '+', '-', '*', and
	 * '/'.
	 * 
