...
/**
 * Simple console UI for the MazeExplorer. Attaches an observer to the maze so
 * that user has to press ENTER for next cell update.
 */
...
/**
 * Implementation of GridObserver that prints out the maze and then waits for
 * user to press ENTER before continuing to next step of search.
 */
