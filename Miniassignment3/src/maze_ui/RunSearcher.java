...
public class RunSearcher {
	...
	public static final String[] MAZE0 = { "###", "#S#", "###", };

	public static final String[] MAZE1 = { "#######", "#  #$ #", "# ### #", "#  #  #", "# ### #", "#     #", "#S#####",
			"#######", };
	...
	public static final String[] MAZE5 = { "#############################", "#                          S#",
			"### #### # ## # ### # # ## ##", "# #    # #    #     ##  ##  #", "# ###### ###########   #   ##",
			"#        #           ### ## #", "########### # #### # # #    #", "#           #    # #   # ####",
			"# # # # ### # ## # ##### #  #", "#   ### # # #    #    ## #  #", "## #  # # # ######### ## ## #",
			"#  ## # # #       # # ##    #", "##    # #   ### # # # ##    #", "#  ###### # # # # #   #### ##",
...
//    GameBoard g = new GameBoard(20, 30);
//    g.generator();
//    String[] board = g.gameBoardToStringArray(true);   
//
//    // Create the maze from the string description
//    final Maze maze = new Maze(board);

		// final Maze maze = new Maze(GIANT_MAZE);
		final TwoDMaze maze = new TwoDMaze(GIANT_MAZE);
	...
	protected static void createAndShow(final TwoDMaze maze, final int sleepTime) {
		...
		panel.setPreferredSize(
				new Dimension(maze.getNumColumns() * MazePanel.cellSize, maze.getNumRows() * MazePanel.cellSize));
